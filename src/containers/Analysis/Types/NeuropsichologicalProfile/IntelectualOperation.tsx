...
const NeuropsichologicalProfileIntelectualOperationContainer: React.FC = () => {
  const category = 'intelectualOperation';
  ...
  const categories = [
    {
      id: 'intelectualOperation',
      name: intl.formatMessage({
        id: 'analysis.neuropsichologicalProfile.intelectualOperation',
      }),
      questions: [{ id: 'intelectualOperation' }],
    },
  ];
  ...
  return (
    <NeuropsichologicalProfileCategoryFormQuestionsComponent
      ...
      titleTooltip="analysis.neuropsichologicalProfile.intelectualOperationTooltip"
      description={intl.formatMessage({
        id:
          'analysis.neuropsichologicalProfile.intelectualOperationDescription',
      })}
      {...{
        categories,
...
export default NeuropsichologicalProfileIntelectualOperationContainer;
